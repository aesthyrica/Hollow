...
//    NSString *htmlFilePath = [[NSBundle mainBundle] pathForResource:@"YoutubeParserBridge" ofType:@"html"];
    NSString *originalHtmlString = [NSString stringWithContentsOfFile:@"/Library/Application Support/BH/Ressources.bundle/YoutubeParserBridge.html" encoding:NSUTF8StringEncoding error:nil];
