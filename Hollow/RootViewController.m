...
//    self.modalPresentationStyle = UIModalPresentationFullScreen;
    ...
    UIImageView *Settingimage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"/Library/Application Support/BH/Ressources.bundle/ic_settings"]];
    UIBarButtonItem *Closebarbuttton = [[UIBarButtonItem alloc] initWithImage:image.image style:UIBarButtonItemStylePlain block:^(id weakSender) {
        [self dismissViewControllerAnimated:true completion:nil];
    }];
    UIBarButtonItem *SettingBarButton = [[UIBarButtonItem alloc] initWithImage:Settingimage.image style:UIBarButtonItemStylePlain block:^(id weakSender) {
        [[SettingViewController alloc] loadSettingPrefsOnViewController:self];
    }];
    [Closebarbuttton setTintColor:[UIColor whiteColor]];
    ...
    self.navigationItem.title = [[NSString string] localizedStringForKey:@"downloaded_library"];
...
- (void)SetupViewController {
    ...
    self.tabbar = [[KPSmartTabBar alloc] initWithViewControllers:@[VideoVC, AudioVC] frame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) options:@{
                                                                                                                                                                         ...
                                                                                                                                                                         KPSmartTabBarOptionSelectionIndicatorColor : [UIColor whiteColor],//[UIColor colorWithRed:8.0/255.0 green:150.0/255.0 blue:225.0/255.0 alpha:1.0],
                                                                                                                                                                         KPSmartTabBarOptionMenuMargin:@(20.0),
                                                                                                                                                                         KPSmartTabBarOptionMenuHeight: @(40.0),
                                                                                                                                                                         KPSmartTabBarOptionSelectedMenuItemLabelColor: [UIColor whiteColor],//[UIColor colorWithRed:8.0/255.0 green:150.0/255.0 blue:225.0/255.0 alpha:1.0],
