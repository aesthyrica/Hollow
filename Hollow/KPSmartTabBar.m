...
- (void)configureUserInterface
{
    ...
    for (UIViewController *controller in _controllerArray) {
        ...
        if (_useMenuLikeSegmentedControl) {
            ...
            if (index == 0) {
                titleText = controllerTitle != nil ? controllerTitle : [[NSString string] localizedStringForKey:@"video"];
            }
            
            if (index == 1) {
                titleText = controllerTitle != nil ? controllerTitle : [[NSString string] localizedStringForKey:@"audio"];
            }
